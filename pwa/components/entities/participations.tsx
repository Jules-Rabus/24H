...
import { ListGuesser, CreateGuesser, EditGuesser, ShowGuesser, InputGuesser, FieldGuesser } from '@api-platform/admin';
import { DateField, ReferenceField, ReferenceInput, SelectInput, TextField, DateTimeInput, TextInput, DateInput } from 'react-admin';
...
export const ParticipationsList = (props: any) => (
  ...
  >
    <ReferenceField source="run" reference="runs">
      <DateField source="startDate" showTime label="Date de début" options={{
    ...
    <DateField source="arrivalTime" showTime label="Date d'arrivée" options={{
      month: '2-digit', day: '2-digit', hour: '2-digit', minute: '2-digit'
    }} />
