...
const defaultMedias = () => [
  buildRaceMedia({
    id: 1,
    filePath: "photo1.jpg",
    contentUrl: "https://picsum.photos/seed/race-1/600/400",
  ...
  buildRaceMedia({
    id: 2,
    filePath: "photo-video1.jpg",
    contentUrl: "https://picsum.photos/seed/race-2/600/400",
    comment: null,
    likesCount: 4,
    contentType: "image/jpeg",
  ...
  buildRaceMedia({
    id: 3,
    filePath: "photo2.jpg",
    contentUrl: "https://picsum.photos/seed/race-3/600/400",
