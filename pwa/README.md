...
Contains a [Next.js](https://nextjs.org/) project bootstrapped with [npm](https://www.npmjs.com/) and [`create-next-app`](https://github.com/vercel/next.js/tree/canary/packages/create-next-app).
