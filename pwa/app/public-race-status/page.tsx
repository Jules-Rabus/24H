...
export default function PublicRaceStatusPage() {
  ...
  const { data: raceData } = useQuery({
    queryKey: QUERY_KEYS.RACE_STATUS,
    queryFn: fetchRaceStatus,
  });
          ...
          <VStack align="stretch" gap="4">
            <Box p="6" bg="white" rounded="xl" shadow="sm">
              <Heading size="md" mb="4">
                Derniers Arrivants (Boucle de 4km)
              </Heading>
            ...
            <Box p="6" bg="surface-container-low" rounded="xl">
              <Heading size="sm" mb="4" color="on-surface">
                Envie de partager un moment ?
              </Heading>
              <Text fontSize="sm" color="on-surface-variant" mb="4">
                Scannez le QR Code depuis votre téléphone ou rendez-vous sur
                /upload pour ajouter une photo à la galerie de la course.
              </Text>
