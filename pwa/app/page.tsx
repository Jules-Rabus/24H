...
const mercureUrl = process.env.NEXT_PUBLIC_MERCURE_HUB_URL ?? ""

const services = [
  { image: apiPicture, title: "API", url: `${apiUrl}/api/docs` },
  { image: adminPicture, title: "Admin", url: "/legacy/admin" },
  {
    image: mercurePicture,
    title: "Mercure debugger",
    url: `${mercureUrl}/.well-known/mercure/ui/`,
  },
]
        ...
        <Container maxW="6xl" px={{ base: "4", md: "20" }} pt="24" pb="8">
          <Flex direction="row" align="flex-start">
            ...
            <Box
              ...
              w="2/5"
              flexShrink={0}
              transform={{ base: "none", lg: "none", md: "scaleX(1.5) scaleY(1.5)" }}
            ...
            >
              <Heading as="h1" size="4xl" lineHeight="1.1">
                <Text as="span" display="block" color="cyan.200" fontWeight="bold" fontSize="2xl" mb="2">
                  Welcome to
                </Text>
        ...
        {[
          {
            ...
            icon: (
              <svg viewBox="0 0 20 20" aria-hidden="true" fill="currentColor" width="20" height="20">
