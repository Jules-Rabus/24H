          ...
          >
            <Stack>
              <form.Field
                ...
                validators={{
                  onChange: ({ value }) => {
                    const parsed = z
                      .string()
                      .min(1, "Veuillez sélectionner un coureur")
                      .safeParse(value);
                  ...
                  <Box>
                    ...
                    >
                      ...
                      {runners?.["hydra:member"]?.map((r: any) => (
                        <option key={r.id} value={`/users/${r.id}`}>
              ...
              <Button
                ...
                w="full"
                colorScheme="primary"
                disabled={!form.state.canSubmit || uploadMutation.isPending}
              >
