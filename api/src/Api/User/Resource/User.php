...
namespace App\Api\User\Resource;
...
use App\Api\User\Dto\UserCollection;
...
#[ApiResource(
    ...
    operations: [
        ...
        new Get(security: 'is_granted("ROLE_ADMIN") or (user and object.getUserIdentifier() == user.getUserIdentifier())'),
        new Get(
